...
<br/>
  ...
  <div class="responsive" style="margin-left: 160px;">
      <div class="gallery">
        <a target="_blank" href="img/techtalk/1.jpg">
          <img src="img/techtalk/1.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> dengan Pemateri<br><b>Eby Sofyan Fadli</b></i></div>
      </div>
  </div>

  <div class="responsive" >
      <div class="gallery">
        <a target="_blank" href="img/techtalk/2.jpg">
          <img src="img/techtalk/2.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> Programming Community 2017</i></div>
      </div>
  </div>

  <div class="responsive" >
      <div class="gallery">
        <a target="_blank" href="img/techtalk/5.jpg">
          <img src="img/techtalk/5.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> dengan Pemateri<br><b>Eby Sofyan Fadli</b></i></div>
      </div>
  </div>
  ...
  <div class="responsive coba" style="margin-left: 160px; margin-top: 15px;">
      <div class="gallery">
        <a target="_blank" href="img/techtalk/3.jpg">
          <img src="img/techtalk/3.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> dengan Pemateri<br><b>Ahmad Harmain</b></i></div>
      </div>
  </div>

   <div class="responsive" style="margin-top: 15px;">
      <div class="gallery">
        <a target="_blank" href="img/techtalk/4.jpg">
          <img src="img/techtalk/4.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> dengan Pemateri<br><b>Ahmad Harmain</b></i></div>
      </div>
  </div>
    ...
    <div class="responsive" style="margin-top: 15px;">
      <div class="gallery">
        <a target="_blank" href="img/techtalk/6.jpg">
          <img src="img/techtalk/6.jpg" alt="Trolltunga Norway" width="300" height="200">
        </a>
        <div class="desc" style="font-family: verdana; font-size: 16px;"><i>Tech<b>Talk</b> dengan Pemateri<br><b>Romy Choirudin</b><br>Materi : Mengkaji Dahsyatnya Vue.Js</i></div>
      </div>
  </div>
