      ...
      <div class="media">
            <div class="media-left">
              <div class="content-avatar">
                  <img class="rounded-circle" src="img/AF.jpg" alt="Generic placeholder image" width="110" height="110">
              </div>
            </div>
       
          <div class="media-body" style="margin-top: 20px; margin-left: 15px;">
            <div class="content-name"><span class="content-authorname official-author"><a href="#">Ridwikus</a></span></div>
              <div class="content-position">You Already Know What It is</div>
                <div class="content-date">June 2, 2017</div>
          </div>
      </div><br/>

       <h2>Google Buat Doodle Belajar Ngoding Untuk Anak-anak</h2><br/>
       <img class="" src="img/artikel/art1.png" alt="Generic placeholder image" width=720 height="350">
       <br/>
       <br/>
       <p style="font-size: 19px;">Dalam rangka mendukung program <i>Computer Science Education Week</i>, Google hari ini merilis Doodle bertema koding untuk anak-anak. Doodle lucu yang mengajak anak-anak mencoba belajar ngoding melalui antarmuka block ini diberi nama <i>"Coding for Carrots".</i></p>
    </div>
